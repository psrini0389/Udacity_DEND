...
frequent_rides_task = PostgresOperator(
    task_id = "frequent_rides",
    dag = dag,
    sql = """
          BEGIN;
        DROP TABLE IF EXISTS lifetime_rides;
...
count_stations_task = PostgresOperator(
